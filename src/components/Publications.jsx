    ...
    return (
        <div className="publications">
            <div className="publications-container" >
                <h1>Publications:</h1>
                <div className="flex flex-col w-full items-center text-white md:grid md:grid-cols-2 xl:grid-cols-3 gap-4">
                        ...
                        return (
                            <a href={blog.link} target="_blank" rel="noopener noreferrer" key={blog.guid}
                                ...
                                <div className="publications-card">
                                    <img src={getBlogImage(blog.description)} alt={blog.title} />
                                    <div className="p-2">
                                        <h2>{blog.title}</h2>
                                        <p className="text-base m-2">{new Date(blog.pubDate).toDateString()}</p>
                                    </div>
                                </div>
                            </a>
                        );
