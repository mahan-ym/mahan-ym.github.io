        ...
        <div className={"relative w-screen h-screen overflow-hidden"}>
            <div className="relative flex flex-rowitems-center w-full h-full">
                <div className="relative ml-4 xl:w-2/5 w-full h-full content-center">
                    <h1 className="text-4xl md:text-8xl font-orbitron font-bold text-white w-full m-4">Mahan Y.T</h1>
                    <h2 className="text-2xl md:text-4xl font-orbitron font-bold text-white w-full m-4">Software Engineer</h2>
                </div>
